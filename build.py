...
HOTELS = [
 dict(slug="yunak", name="Yunak Evleri", logo="yunak-logo.png",
      ...
      links=[("sheet","Otel Künyesi","Fact Sheet (İngilizce)","https://publuu.com/flip-book/877949/2410703"),
 ...
 dict(slug="asmalikonak", name="Asmalı Konak Cave Suites", logo="asmali-logo.png",
      ...
      links=[("sheet","Otel Künyesi","Fact Sheet (İngilizce)","https://publuu.com/flip-book/877949/2410701"),
 ...
 dict(slug="misty", name="The Misty Cave Hotel", logo="misty-logo.png",
      accent="#3c9dc8", ga="rgba(60,157,200,.28)", gb="rgba(30,80,120,.30)",
      tagline="Kapadokya manzarasına bakan sıcak ve sakin mağara odalar.",
      links=[("sheet","Otel Künyesi","Fact Sheet (İngilizce)","https://publuu.com/flip-book/877949/2410700"),
